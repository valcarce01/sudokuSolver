...
class solver:
    ...
    def generate_posibilities(self):
        ...
        for row_index in range(9):
            ...
            row = set(self.sudoku.get_row(row_index))
            ...
            for col_index in range(9):
                ...
                if self.sudoku.get_value((col_index, row_index)) == 0:
                    # The column we are studying:
                    # col = set(self.sudoku.get_column(col_index))
                    # print(self.sudoku.get_column(col_index))
        ...
        for item in self.sudoku._sudoku_values:
            print(item)
